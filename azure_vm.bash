...
SPN_ID=$(eval echo "\${INSTRUQT_AZURE_SUBSCRIPTION_${INSTRUQT_AZURE_SUBSCRIPTIONS}_ADMIN_SPN_ID}")
SPN_PASSWORD=$(eval echo "\${INSTRUQT_AZURE_SUBSCRIPTION_${INSTRUQT_AZURE_SUBSCRIPTIONS}_ADMIN_SPN_PASSWORD}")
